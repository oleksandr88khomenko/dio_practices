...
public class ArrayHelper {
    ...
    public List<Person> union(List<Person> firstArr, List<Person> secondArr) throws MyExceptions {

        if (firstArr == null || firstArr.size() == 0 || secondArr == null || secondArr.size() == 0)
            throw new MyExceptions(firstArr, secondArr);

        List<Person> result = new ArrayList<Person>(firstArr);
